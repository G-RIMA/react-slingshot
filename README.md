...
---
I am gonna Added CI/CD functionality to run the code and test for errors.
This is my first CI/CD pipeline with working code.
The steps I take are:
  
## Questions?We will use an existing application for convenience. If you'd like to use your own application, that's fine, but be aware there may be some differences. To use the suggested application, please fork and clone this repository.
